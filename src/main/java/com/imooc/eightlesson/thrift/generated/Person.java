 ...
 *  @generated
 */
package com.imooc.eightlesson.thrift.generated;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2019-09-20")
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.AGE,_Fields.IS_MARRIED};
  ...
  public void unsetIsMarried() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ISMARRIED_ISSET_ID);
  }

  /** Returns true if field isMarried is set (has been assigned a value) and false otherwise */
  public boolean isSetIsMarried() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ISMARRIED_ISSET_ID);
  }

  public void setIsMarriedIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ISMARRIED_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIsMarried()) ? 131071 : 524287);
    if (isSetIsMarried())
      hashCode = hashCode * 8191 + ((isMarried) ? 131071 : 524287);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetIsMarried()).compareTo(other.isSetIsMarried());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsMarried()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isMarried, other.isMarried);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
